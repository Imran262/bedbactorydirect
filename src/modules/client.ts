...
import { SagePay } from './vsf-sagepay-integration';
import { sampleQuote } from './cut-full-sample';
...
import { LayeredNavigationModule } from './vsf-layered-nav'
...
export function registerClientModules () {
  ...
  registerModule(SagePay)
  registerModule(sampleQuote)
