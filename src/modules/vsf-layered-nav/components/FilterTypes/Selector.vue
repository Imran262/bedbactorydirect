...
export default {
  ...
  methods: {
    setComfortColor(variant) {
      if (variant.id === 203 || variant.id === "203") {
        return "color-soft";
      } else if (variant.id === 204 || variant.id === "204") {
        return "color-medium-soft";
      } else if (variant.id === 205 || variant.id === "205") {
        return "color-medium";
      } else if (variant.id === 206 || variant.id === "206") {
        return "color-medium-firm";
      } else if (variant.id === 207 || variant.id === "207") {
