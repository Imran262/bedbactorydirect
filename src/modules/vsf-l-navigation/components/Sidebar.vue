<template>
  <div class="sidebar sb-category-filter">
    ...
    <div
      class="sb-category-filter-inner"
...
<script>
import ProductFilter from "src/modules/vsf-l-navigation/components/ProductFilter";
