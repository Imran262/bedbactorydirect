  ...
  PRoduct Tile TM
    ...
    >
      ...
      >
        ...
        <span>
          <p class="only11" v-if="product.size !=='PALLET' && product.size !=='pallet' && product.size !=='Pallet'">
        ...
        <span class="p-from">
          <p class="only">
            <span class="priceprod">
              {{ product.price | price(storeView) }}/<span v-if="productTileTypeUnitCheck(product) !== 'piece'"
              v-html="productTileTypeUnitCheck(product)">/</span>
            </span>
          </p>
          <div class="rating1">
            <rating
      ...
      <div class="detailsprod">
        <span class="sign">
          ...
          <span>
            <p class="only1" v-if="product.sizes !=='PALLET' && product.sizes !=='pallet' && product.sizes !=='Pallet'">
              <span v-if="product.sizes">Size: {{ product.sizes[0] }}</span>
            </p>
          </span>
          <span class="p-from">
            <p class="only">
              <span class="priceprod">
                ...
                <span v-if="productTileTypeUnitCheck(product) !== 'piece'">/</span><span v-if="productTileTypeUnitCheck(product) !== 'piece'" v-html="productTileTypeUnitCheck(product)">/</span>
              </span>
            </p>
            <div class="rating">
              <rating
                :score="
                  product.average_score ? parseFloat(product.average_score[0]) : 0
                "
              />
              <span data-v-e79937e8 class="reviews">
                ({{ product.total_reviews ? product.total_reviews[0] : 0 }})
              </span>
            </div>
          </span>
        </span>
