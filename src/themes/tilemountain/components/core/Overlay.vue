  ...
  methods: {
    ...
    toggleMenu () {
      setTimeout(function () {
        ...
        if (sidebarMenu != null) {
          console.log('9512 vissible BEFORE in overlay',bodyVar.classList)
          bodyVar.classList.remove('body-fixed');
          console.log('9512 vissible AFTER in overlay',bodyVar.classList)
          return ;
        }
      }, 100)
    }
