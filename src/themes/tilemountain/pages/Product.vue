<template>
  ...
  >
    ...
    <section class="bg-cl-secondary px20 product-top-section">
      <div class="container">
        <section class="row m0 between-xs">
          <template v-if="getCurrentProduct.average_score">
            <div
              class
            ...
            >
              <meta
                ...
                :content="getCurrentProduct.average_score"
              />
              <meta
                itemprop="ratingCount"
                :content="getCurrentProduct.total_reviews"
              />
            </div>
          ...
          <div class="col-xs-12 col-md-12 col-lg-6 data product-detail">
            <div class="product-detail-inner">
              ...
              >
                ...
                <div class="rating">
                  <rating
                    ...
                    :score="
                      getCurrentProduct.average_score
                        ? parseFloat(getCurrentProduct.average_score)
                        : 0
                    "
                  />
                  <span class="reviews" @click="navigateToReviews">
                    {{
                      getCurrentProduct.total_reviews
                        ? getCurrentProduct.total_reviews
                        : 0
                    }}
                    Reviews</span
                ...
                <div class="row">
                  <div class="col-xs-6 col-md-6 col-lg-6 col-xl-7">
                    <span
                      class="size-value"
                  ...
                  <div class="col-xs-6 col-md-6 col-lg-6 col-xl-5">
                    <span
              ...
              <div class="sample-detail" v-if="hasSamples">
                <div class="row" v-if="!isSampleSelected">
                  <div
                    class="col-xs-12 col-lg-6 full-size-sample"
                    v-if="availableSamplesTypes.includes('full_size')"
                    id="full-size-sample"
                  >
                    <FullSizeSample
                      :product="getCurrentProduct"
                      :cart-id="getCartToken"
                      :disabled="fullSampleButtonDisable"
                      @sampleRes="disableSampleButton"
                      :price="hasSampleType('full_size').price"
                    />
                  </div>
                  <div
                    class="col-xs-12 col-lg-6 vinyl-product-support"
                    v-if="
                  ...
                  >
                    <p>
                      Please note: This product is sold in full packs of {{perBox}}m<sup>2</sup> per box.
                    </p>
                  </div>
                  <div
                    class="col-xs-12 col-lg-6 free-cut-sample"
                    v-if="availableSamplesTypes.includes('cut_size')"
                    id="free-cut-sample"
                  >
                    <CutSizeSample
                      :product="getCurrentProduct"
                      :cart-id="getCartToken"
                      :disabled="cutSampleButtonDisable"
                      @sampleRes="disableSampleButton"
                      :price="hasSampleType('cut_size').price"
                      :similar-cut-disabled="similarCutDisabled"
                    />
                  </div>
                  <div
                    class="col-xs-12 col-lg-6 half-size-sample"
                    v-if="availableSamplesTypes.includes('half_size')"
                    id="half-size-sample"
                  >
                    <HalfSizeSample
                      :product="getCurrentProduct"
                      ...
                      :disabled="cutSampleButtonDisable"
                      @sampleRes="disableSampleButton"
                      :price="hasSampleType('half_size').price"
                    />
                  </div>
                  <div
                    class="col-xs-12 col-lg-6 q-size-sample"
                    v-if="
                      availableSamplesTypes.includes('quarter_size') &&
                      hasSampleType('quarter_size').status
                    "
                    id="q-size-sample"
                  >
                    <QSizeSample
                      ...
                      :disabled="cutSampleButtonDisable"
                      @sampleRes="disableSampleButton"
                      :price="hasSampleType('quarter_size').price"
                    />
                  </div>
                </div>
                <div class="row" v-else>
                  <div
                    class="col-xs-12 col-lg-6 col-lg-offset-6 full-size-sample"
                    id="added_to_basket"
                  >
                    <AddedToBasket @atcPixel="atcPixel"/>
                  </div>
                </div>
              </div>
              <div
                ...
                <div class="row">
                  ...
                  >
                    <div class="row">
                      ...
                      <div
                        class="col-lg-4 col-md-5 col-xs-6 border-sqm-bottom"
                        v-if="getCurrentProduct.qty_per_sqm"
                      >
                      ...
                      <div
                        class="col-lg-4 col-md-5 col-xs-6 border-tile-bottom"
                      >
                        <product-quantity
                          class="row m0 mb10"
                          :class="
              ...
              <div class="add-to-cart row m0">
                ...
                <div
                  class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-margin addtocartbuttonMobile"
                >
                  <add-to-cart
                    :product="getCurrentProduct"
                    :disabled="
    ...
    <!-- <SizeGuide /> -->
    <div
      v-if="getImageObjJsonLd"
      itemscope
      itemtype="https://schema.org/ImageObject"
    >
      <meta itemprop="representativeOfPage" content="true"/>
      <meta itemprop="caption" :content="getCurrentProduct.name"/>
      <meta itemprop="thumbnail" :content="getImageObjJsonLd"/>
    </div>
    <div
      v-if="getVideoObjJsonLd"
      itemscope
      itemtype="https://schema.org/VideoObject"
    >
      <meta itemprop="name" :content="getCurrentProduct.name"/>
      <meta itemprop="description" :content="getCurrentProduct.name"/>
      <meta itemprop="thumbnailUrl" :content="getVideoObjJsonLd.thumbnailUrl"/>
      <meta itemprop="duration" content=""/>
      <meta itemprop="uploadDate" :content="getCurrentProduct.created_at"/>
      <meta itemprop="contentUrl" :content="getVideoObjJsonLd.contentUrl"/>
    </div>
    <div
      v-if="getWebPageObjJsonLd"
      itemscope
      itemtype="https://schema.org/WebPage"
    >
      <meta itemprop="image" :content="getWebPageObjJsonLd"/>
    </div>
    <ReviewItemImageModel name="modal-ReviewItemImageModel"/>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    perBox () {
      if(this.getCurrentProduct.box_coverage) {
        ...
        return this.roundTo(
          1 / this.getCurrentProduct.qty_per_sqm,
          2)
      }
    },
    socialLinksSchema () {
    ...
    structuredData () {
      const stockText = this.getCurrentProduct.stock_level_text ? this.getCurrentProduct.stock_level_text : ''
      let stockTextString = ''
      console.log('stockText', stockText, stockText.indexOf('More') !== -1)
      if(((stockText.indexOf('Available') !== -1) === true) || ((stockText.indexOf('available') !== -1) === true) || ((stockText.indexOf('In Stock') !== -1) === true) || ((stockText.indexOf('in Stock') !== -1) === true) || ((stockText.indexOf('in stock') !== -1) === true) || ((stockText.indexOf('Please call') !== -1) === true)) {
      ...
      return Object.values(this.attributesByCode || [])
        .filter(
          (a) =>
            ...
            (this.getCurrentProduct[ a.attribute_code ] || this.getCurrentProduct[ a.attribute_code ] === 0)
        )
        .sort((a, b) => {
  ...
  async mounted () {
    ...
    this.updateHasSamples(this.getCurrentProduct.id)
      .then(({ data }) => {
        if(data.code && data.code === 200 && data.result && data.result.length && data.result.length > 0) {
    ...
    if(this.$store.state.url.prevRoute && this.$store.state.url.prevRoute.name && this.$store.state.url.prevRoute.name.includes('.html') && this.$store.state.url.prevRoute.params) {
      localStorage.setItem('topLevelCategoryPosition', this.$store.state.url.prevRoute.params.slug)
    }
    // For GTAG
  ...
  watch: {
    ...
    currRoute (newVal, oldVal) {
      ...
      if(document.getElementById('prod-gallery-thumbnails-carousel')) {
        const sliderThumb = document.getElementById('prod-gallery-thumbnails-carousel').querySelector('.VueCarousel-inner')
  ...
  methods: {
    ...
    addBloom () {
      if(config && config.bloomreach) {
        ...
        br_data.title = this.getCurrentProduct.meta_title || this.getCurrentProduct.name
    ...
    async getVinylProductItem () {
      if(this.getCurrentProduct && this.getCurrentProduct.filter_type && this.getCurrentProduct.filter_type === 'Pack') {
        this.vinylPayload.productId = this.getCurrentProduct.id
        await this.$store.dispatch('vinyl/getVinylItems', this.vinylPayload).then((res) => {
          if(res.success) {
    ...
    async getVinylItemProducts () {
      ...
      if(this.vinylProducts.recommend && this.vinylProducts.recommend.length > 0) {
    ...
    async checkIfProductHasGroutAndAdhesive () {
      this.payload.data.product_id = this.getCurrentProduct.id
      await this.$store.dispatch(
        'groutadhesive/groutAdhesiveFunction', this.payload).then((resp) => {
          let response = JSON.parse(resp)
          if(response.success) {
            if(response.recommendation) {
              this.groutAdhesiveOptions = response.data
              this.sqmCheckForModelType = true
              this.fixing = response.data.fixing_type
              this.madeOf = response.data.applied_material
              this.groutJoint = response.data.grout_width
              this.minSqmValue = response.min_sqm
            } else if(!response.recommendation) {
              this.groutAdhesiveOptions = []
    ...
    async disabledQuoteAddtoCart () {
      if(this.getCartToken && this.getCartToken !== '' && this.getCartToken !== null) {
    ...
    async getSimilarTiles () {
      ...
      if(this.similar_products.skus && this.similar_products.skus.length > 0) {
        ...
        await this.$store
          ...
          .then(({ items }) => {
            this.similar_products.items = items.filter(i => !i.product_banner_image?.includes('Out_of_Stock'))
            // Also update the skus, remove the ones not included in items.
            this.similar_products.skus = this.similar_products.items.filter(i => this.similar_products.skus.includes(i.sku))
          })
          .catch((err) => {
    ...
    updateSqmQuantity (productQuantity) {
      console.log('productQuantity', productQuantity, this.getCurrentProduct.qty, this.tileSqmQuantity)
    ...
    SqmValUpdated (sqmQuantity, wasteCheck = true) {
      if(sqmQuantity === '') {
        if(this.getCurrentProduct && this.getCurrentProduct.filter_type && this.getCurrentProduct.filter_type === 'Pack') {
          let vinylAccessories = document.getElementById('vinyl-accessories-box')
  ...
  metaInfo () {
    ...
    let metaDescription = this.getCurrentProduct.description ? this.getCurrentProduct.description.replace(/<\/?[^>]+(>|$)/g, '') : ''
    let metaLength = 233
    if(metaDescription) {
      metaDescription = metaDescription.length > metaLength ? metaDescription.substring(0, metaLength - 3) + '...' : metaDescription
    }
    let metaData = [
      {
        property: 'og:url',
        content: this.getCurrentProduct.canonical_url ? this.getCurrentProduct.canonical_url : '/' + this.getCurrentProduct.url_path
      },
      {
        property: 'og:title',
        content: htmlDecode(
      ...
      },
      {
        ...
        content: this.getCurrentProduct.meta_description ? this.getCurrentProduct.meta_description : metaDescription
      },
      {
        property: 'og:image',
        content: config.images.baseUrl + '1200/630/resize/catalog/product' + (this.getCurrentProduct.google_feed_img ? this.getCurrentProduct.google_feed_img : this.getCurrentProduct.image)
      }
    ]
    ...
    return {
      link: [
        {
          rel: 'canonical',
          href: this.getCurrentProduct.canonical_url ? this.getCurrentProduct.canonical_url : '/' + this.getCurrentProduct.url_path
        }
      ],
      title: htmlDecode(
        this.getCurrentProduct.meta_title || this.getCurrentProduct.name
