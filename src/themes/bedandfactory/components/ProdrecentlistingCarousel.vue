<template>
  <no-ssr>
    <carousel
      ...
      navigation-next-label="<i class='recent-right-arrow cl-bg-tertiary-new material-icons p15  pointer'>keyboard_arrow_right</i>"
      navigation-prev-label="<i class='recent-left-arrow cl-bg-tertiary-new material-icons p15  pointer'>keyboard_arrow_left</i>"
    >
