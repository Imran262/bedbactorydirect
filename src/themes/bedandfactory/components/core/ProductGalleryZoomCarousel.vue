    ...
    <div class="media-zoom-carousel__container row flex">
      <ul class="media-zoom-carousel__thumbs m0 p0" ref="thumbs">
        <li
          ...
          :key="images.src"
        >
          <product-image @click="navigate(index)" :image="images" :alt="productName | htmlDecode" />
        </li>
      </ul>
...
.media-zoom-carousel__thumb .product-image.product-image--width {
  padding-bottom: 100% !important;
}
.media-zoom-carousel__slide.bg-cl-secondary
