  ...
  >
    ...
    >
      ...
      <img
        ...
        @touchmove="calcZoomPosition($event)"
        class="zoomed-image"
  ...
  methods: {
    ...
    calcZoomPosition(event) {
      if (this.zoomed) {
        ...
        let relativeX = clientX - offset.x + window.pageXOffset;
        let relativeY = clientY - offset.y + window.pageYOffset;
