            ...
            <div class="newsLetterCont">
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                  <h2>Stay In Touch</h2>
                  <span class="getInfo">
                    Get info about offers, giveaways and new products
                  </span>
                  <form action="">
                    <input
                      type="email"
    ...
    <div class="mobile-footer" v-show="$device.isMobile">
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 mobileFooterForm">
            <h2>Stay In Touch</h2>
            <span class="getInfo">
              Get info about offers, giveaways and new products
            </span>
          ...
          <!-- </div> -->
          <div class="col-12 securePaymentMobile">
            <img src="/assets/lock.svg" />
    ...
    <div class="copyright">
      <div class="container">
        <div class="row">
          ...
          <div
            class="col-xs-6 col-sm-6 col-md-4 col-lg-4 mobieBottomFooterCont"
          >
